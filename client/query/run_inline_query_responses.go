...
func (o *RunInlineQueryOK) Error() string {
	return fmt.Sprintf("[POST /queries/run/{format}][%d] runInlineQueryOK  %+v", 200, o.Payload)
}
...
func (o *RunInlineQueryBadRequest) Error() string {
	return fmt.Sprintf("[POST /queries/run/{format}][%d] runInlineQueryBadRequest  %+v", 400, o.Payload)
}
...
func (o *RunInlineQueryNotFound) Error() string {
	return fmt.Sprintf("[POST /queries/run/{format}][%d] runInlineQueryNotFound  %+v", 404, o.Payload)
}
