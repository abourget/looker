...
func (o *CreateModelSetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		result := NewCreateModelSetInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewCreateModelSetInternalServerError creates a CreateModelSetInternalServerError with default headers values
func NewCreateModelSetInternalServerError() *CreateModelSetInternalServerError {
	return &CreateModelSetInternalServerError{}
}

/*CreateModelSetInternalServerError handles this case with default header values.

Server Error
*/
type CreateModelSetInternalServerError struct {
	Payload
}

func (o *CreateModelSetInternalServerError) Error() string {
	return fmt.Sprintf("[POST /model_sets][%d] createModelSetInternalServerError  %+v", 500, o.Payload)
}

func (o *CreateModelSetInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
